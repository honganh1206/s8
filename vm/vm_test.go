...
func TestFirstClassFunctions(t *testing.T) {
	tests := []vmTestCase{
		{
			input: `
let returnsOne = funk() { 1; };
let returnsOneReturner = funk() { returnsOne; };
returnsOneReturner()();
`,
			expected: 1,
		},
...
func TestCallFunctionsWithWrongArguments(t *testing.T) {
	tests := []vmTestCase{
		{
			input:    `funk() { 1; }(1);`,
...
func testExpectedObject(t *testing.T, expected any, actual object.Object) {
	...
	case []int:
		// Ensure *object.Array ends up on the top of the stack
